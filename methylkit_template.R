...
genome_assembly <- "hg19"  # <--- MODIFY

# Thresholds for filtering
min_coverage <- 10 # <--- MODIFY
max_coverage_percentile <- 99.9 # <--- MODIFY
sd_cutoff <- 2.0 # <--- MODIFY


# Binning parameters (region-level analysis)
tile_win_size  <- 500 # <--- MODIFY
tile_step_size <- 300 # <--- MODIFY
...
sample_group_recode <- c("Group1"=0, "Group2"=1) # <--- MODIFY

# Column names in your samplesheet
group_column <- "Sample_Group" # <--- MODIFY
file_column  <- "file_name" # <--- MODIFY
id_column    <- "Sample_ID" # <--- MODIFY
